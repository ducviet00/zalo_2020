...
class traffic_sign_detection(traffic_sign_cfg):
    variant: str = '2020'
    splits: Dict[str, dict] = field(default_factory=lambda: dict(
        train=dict(ann_filename='/kaggle/input/trafficlights/za_traffic_2020/za_traffic_2020/traffic_train/train_traffic_sign_dataset.json', 
                   img_dir='/kaggle/input/trafficlights/za_traffic_2020/za_traffic_2020/traffic_train/images', has_labels=True),
        val=dict(ann_filename='/kaggle/input/trafficlights/instances_val2017.json', img_dir='/kaggle/input/trafficlights/za_traffic_2020/za_traffic_2020/traffic_train/images', has_labels=True),
